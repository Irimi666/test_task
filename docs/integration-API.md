# Структура взаимодействия API с внешним сервисом
...
graph TD
    ...
    C -->|4. Уведомление| E[Сервис отправки пушей]
    E -->|5. FCM| F[Android-устройство]
    E -->|6. APNs| G[iOS-устройство]
    C -->|7. Логи| H[Сервис логирования и мониторинга]
